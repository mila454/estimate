...
Call insertCol("Остаток по контрактной смете", 28)
currRow = 0
For Each currRow In totalByPosition
...
Call insertCol("Остаток по исполнительной смете", 30, "255 250 205")
currRow = 0
For Each currRow In totalByPosition
...
Sub insertCol(col_Name, col_ins, Optional fillCol = "255 255 255")
...
Cells(, col_ins).EntireColumn.Insert
Range((Cells(32, (col_ins - 1))), Cells(32, col_ins)).HorizontalAlignment = xlCenterAcrossSelection
Cells(32, col_ins - 1).Value = col_Name
Cells(32, col_ins - 1).WrapText = True
Cells(33, col_ins - 1).Value = "Кол-во"
Cells(33, col_ins - 1).HorizontalAlignment = xlCenter
Cells(33, col_ins).Value = "Стоимость, руб."
Cells(32, col_ins - 1).VerticalAlignment = xlCenter
Set range1 = Range((Cells(32, (col_ins - 1))), Cells(lastCell, col_ins))
If fillCol <> "" Then
