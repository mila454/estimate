Attribute VB_Name = "userFormEstimate2"
Option Explicit
...
Dim subroutine1 As String
Dim subroutine2 As String
...
subroutine1 = "ndsTotal"
subroutine2 = "NDSIncluding"
...
Sub usn()
'итого с учетом налогов и сборов (УСН)
...
Sub simplePrepare()
'подготовка к простому оформлению
...
If totalEstimate.Count > 1 Then
    For i = 1 To totalEstimate.Count - 1
        ...
        If answer = 6 And Cells(totalEstimate(i), 1).Value Like "*Стоимость*посадочного*материала*" Then
            If subroutine2 = "NDSIncluding" Then Call NDSIncluding(totalEstimate(i) + 1)
        Else
            If subroutine1 = "ndsTotal" Then Call ndsTotal(totalEstimate(i), numberCol, letterCol)
        End If
...
If answer = 6 Then
    If subroutine2 = "NDSIncluding" Then Call NDSIncluding(totalEstimate(totalEstimate.Count) + 1)
Else
    If subroutine1 = "ndsTotal" Then Call ndsTotal(totalEstimate(totalEstimate.Count), numberCol, letterCol)
End If
...
If typeEstimate = "ТСН" Then
    If subroutine1 = "ndsTotal" Then Call ndsTotal(totalEstimate(1), 9, "I")
